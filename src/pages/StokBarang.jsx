            ...
            <div style = {{
                ...
                <div>
                    <div style = {{
                        ...
                        <SearchBar placeholder = "Cari nama produk atau kode..." value = {search} onChange = {e => setSearch(e.target.value)} />
                        <button style = {{
                            display: 'flex',
                            alignItems: 'center',
                            gap: 6,
                ...
                <div style = {{
                    ...
                    <div style = {{
                        ...
                        <div style = {{
                            ...
                            Lakukan pengecekan fisik berang untuk memastikan kesesuaian data sistem.
                        </div>
                        <button style = {{
                            background: '#fff',
                            color: '#4A3500',
