            ...
            <div style = {{
                ...
                <ResponsiveContainer width = "100%" height = {200}>
                    <AreaChart data = {omsetData}>
                        ...
                        <XAxis dataKey = "year" tick = {{fontSize: 11, fill: COLOR.textMuted}} axisLine = {false} tickLine = {false} />
                        <YAxis tick = {{fontSize: 11, fill: COLOR.textMuted}} axisLine = {false} tickLine = {false} />
                        <Tooltip />
                        <Area type = "monotone" dataKey = "value" stroke = {COLOR.amber} strokeWidth = {2} fill = "url(#omsetGrad)" dot = {false} />
                    </AreaChart>
                </ResponsiveContainer>
            </div>
